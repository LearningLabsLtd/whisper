...
def cli():
    ...
    parser.add_argument("--beam_size", type=optional_int, default=20, help="number of beams in beam search, only applicable when temperature is zero")
    ...
    # Commented out both arguments as they threw the error: TypeError: __init__() got an unexpected keyword argument <argument>]
